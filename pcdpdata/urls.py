...
urlpatterns = [
    ...
    url(r'^projects/(?P<project_id>\d)/$', views.ProjectDetail.as_view(), name='get-project'),
    ...
    url(r'^results/(?P<assessment_id>\d+)/(?P<user_id>\d+)/$', views.UserResult.as_view(), name='get-results'),
]
